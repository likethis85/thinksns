...
if($_GET['t'] == 'user') {
	...
	if(empty($user_list)) {
		...
		foreach($user_list as &$value) {
			...
			$data[] = "('".$value['uid']."','".$value['email']."','".$password."','".$salt."','".$value['uname']."','".$value['email']."','".$sex."','北京市 北京市 海淀区','1','".$value['is_active']."','".$value['is_init']."','".$value['ctime']."','1',null,'".$value['domain']."','110000','110100','110108', '127.0.0.1', 'zh-cn', 'PRC', '0', '".$first_letter."', '', null, null, '0', '".$search_key."', null)";
			// 添加用户组信息 - todo
