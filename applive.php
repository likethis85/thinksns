...
$query_Recordset1 = "SELECT * FROM t_weibo WHERE uid=8 and isdel=0 order by weibo_id desc limit 40";
...
<table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
  ...
  do { ?> <tr>
    <td width="30px" align="center" valign="top"><?php echo date("H:i",$row_Recordset1['ctime']);?></td>
   
      <td align="left" valign="top"><span class="feed"><?php echo str_replace("&lt;br /&gt;","",getShort(format($row_Recordset1['content']),300,".."));?></span></td>
